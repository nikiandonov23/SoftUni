...
namespace NetPay.Data
{
    ...
    {
        private const string connectionString = @"Server=.;Database=NetPayDb;Trusted_Connection=True;TrustServerCertificate=True";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<SupplierService>()
                .HasKey(x => new { x.ServiceId, x.SupplierId });
