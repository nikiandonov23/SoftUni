...
namespace Cadastre.Migrations
{
    ...
    [Migration("20250407155148_initialMigration4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CitizenProperty", b =>
                {
                    b.Property<int>("PropertiesCitizensId")
                        .HasColumnType("int");

                    b.Property<int>("PropertiesCitizensId1")
                        .HasColumnType("int");

                    b.HasKey("PropertiesCitizensId", "PropertiesCitizensId1");

                    b.HasIndex("PropertiesCitizensId1");

                    b.ToTable("CitizenProperty");
                });
            ...
            modelBuilder.Entity("CitizenProperty", b =>
                {
                    b.HasOne("Cadastre.Data.Models.Citizen", null)
                        .WithMany()
                        .HasForeignKey("PropertiesCitizensId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cadastre.Data.Models.Property", null)
                        .WithMany()
                        .HasForeignKey("PropertiesCitizensId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
