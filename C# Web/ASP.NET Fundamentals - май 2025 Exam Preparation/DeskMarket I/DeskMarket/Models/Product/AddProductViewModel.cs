...
public class AddProductViewModel
{
    ...
    [Range(typeof(decimal),
        ProductPriceMinValueString,
        ProductPriceMaxValueString,
    ...
    public IEnumerable<AddProductCategoryDropDownViewModel> Categories { get; set; } =
        new List<AddProductCategoryDropDownViewModel>();
}