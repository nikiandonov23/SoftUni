...
namespace CarGarage.Data.Migrations
{
    ...
    [Migration("20260419225504_AddMakeModelTables_Existing")]
    partial class AddMakeModelTables_Existing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarGarage.DataModels.MakeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGarage.DataModels.MakeModel", b =>
                {
                    b.HasOne("CarGarage.DataModels.Make", null)
                        .WithMany()
                        .HasForeignKey("MakeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarGarage.DataModels.Model", null)
                        .WithMany()
